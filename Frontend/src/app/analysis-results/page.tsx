  ...
  if (error || !result) {
    return (
      <div className="h-[calc(100vh-8rem)] flex flex-col items-center justify-center gap-4">
        <p className="text-lg text-gray-700">{error || 'Result not found.'}</p>
    ...
    <div className="min-h-[calc(100vh-8rem)] flex flex-col animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 md:mb-6">
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <div>
            <h1 className="text-lg md:text-xl font-display font-bold analysis-results-heading">Analysis Results</h1>
            <p className="text-xs md:text-sm analysis-results-subheading">Document validation and fraud detection report</p>
          </div>
        </div>
        {result && (
          <ExportButton
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-4 md:gap-6">
        ...
        <div className="order-1 lg:order-2 lg:w-1/2 min-h-0">
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4 md:p-6 h-full">
