    ...
    <div className="h-[calc(100vh-8rem)] flex flex-col animate-fade-in">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-display font-bold analysis-results-heading">Analysis Results</h1>
            <p className="text-sm analysis-results-subheading">Document validation and fraud detection report</p>
          </div>
        </div>
